...
const ProductCard = ({ product }) => {
  ...
  return (
      <div
          key={product.id}
          className="flex flex-col justify-between w-full max-w-sm overflow-hidden rounded-lg shadow-lg"
      >
          ...
          <div className="p-4">
              ...
              <button
                  ...
                  className={`flex items-center justify-center w-full gap-2 py-2 text-white transition-colors duration-300 rounded-lg ${
