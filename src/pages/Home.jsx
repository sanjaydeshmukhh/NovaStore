      ...
      <header className="text-white bg-center bg-cover" style={{ backgroundImage: "url('/path/to/your/hero-image.jpg')" }}>
        <div className="py-20 bg-black bg-opacity-50">
          <div className="container mx-auto text-center">
            <h1 className="mb-4 text-5xl font-bold">Welcome to NovaStore</h1>
        ...
        <div className="container mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-8">
            <div className="md:w-1/3 w-full p-4">
              <div className="p-6 bg-gray-100 rounded-lg shadow-md">
                <p className="italic">"Great service and amazing products! Highly recommend NovaStore."</p>
                <p className="mt-4 font-bold">- Deepali </p>
              </div>
            </div>
            <div className="md:w-1/3 w-full p-4">
              <div className="p-6 bg-gray-100 rounded-lg shadow-md">
                <p className="italic">"I love the free shipping and the customer support is top-notch."</p>
                <p className="mt-4 font-bold">- Abhinav </p>
              </div>
            </div>
          </div>
        </div>
